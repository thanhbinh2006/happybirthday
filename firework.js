...
//    let image=document.getElementById('image');
    ...
    class effect2{
        ...
        DrawImage(image){
           ...
           if ((image.height>this.canvasHeight/2)||(image.width>this.canvasWidth/2)){
            while(((image.height/i>this.canvasHeight/2)&&
            ((image.width/i>this.context.canvasWidth/2)))){
                i++;
            };
            ...
            while(((image.height*i<this.canvasHeight/2)&&
            ((image.width*i<this.canvasWidth/2)))){
                i++;
            };this.imageHeight=image.height*i;
